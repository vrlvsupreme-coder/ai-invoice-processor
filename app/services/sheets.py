        ...
        try:
            ...
            if os.path.exists(self.auth_file):
                ...
                try:
                    ...
                    items_headers = [
                        "Invoice No (Ref)", "Sr. No", "Part No / Generic Name", "Description", "HSN/SAC", "Qty", "Rate", "Basic Amount", "Discount Type", "Discount Amount", "Type Amount", "Taxable Amount", "SGST Rate", "SGST Amount", "CGST Rate", "CGST Amount", "IGST Rate", "IGST Amount", "Invoice Amount"
                    ]
